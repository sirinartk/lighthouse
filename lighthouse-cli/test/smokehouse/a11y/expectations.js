            ...
            items: [
              {
                node: {
                  'type': 'node',
                  'selector': 'section:nth-child(32) > div:nth-child(1)',
            ...
            items: [
              {
                node: {
                  ...
                  'path': '2,HTML,1,BODY,33,SECTION,0,TEXTAREA',
            ...
            items: [
              {
                node: {
                  ...
                  'path': '2,HTML,1,BODY,37,SECTION,2,INPUT',
            ...
            items: [
              {
                node: {
                  'type': 'node',
                  'selector': 'h3',
                  'path': '2,HTML,1,BODY,41,SECTION,1,H3',
