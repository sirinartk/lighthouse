...
const UIStrings = {
  ...
  description: 'Focusable descendents within an `[aria-hidden="true"]` element will not be available to assistive technologies like screen readers. [Learn more](https://dequeuniversity.com/rules/axe/3.3/aria-hidden-focus).',
};
